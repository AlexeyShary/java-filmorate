...
CREATE TABLE IF NOT EXISTS USERS_FILMS_LIKES (
	...
	FILM_ID BIGINT NOT NULL,
	CONSTRAINT USERS_FILMS_LIKES_PK PRIMARY KEY (USER_ID,FILM_ID),
...
(
    ...
    CONSTRAINT FILMS_MARKS_FK_U FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID) ON DELETE CASCADE,
    CONSTRAINT FILMS_MARKS_FK_F FOREIGN KEY (FILM_ID) REFERENCES FILMS(FILM_ID) ON DELETE CASCADE
);
